...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border bg-white text-gray-900 shadow-sm overflow-hidden relative flex flex-col",
      className
    )}
    {...props}
  />
...
const CardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("p-6 lg:p-8 pt-0 flex-1", className)} {...props} />
))
